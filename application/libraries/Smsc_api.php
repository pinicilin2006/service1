...
class Smsc_api {
	...
	//Создаём контанты для класса
	// const SMSC_LOGIN = "tklient.ru";
	// const SMSC_PASSWORD = "Aq1sw2de3";
	// const SMSC_POST = 0;
	// const SMSC_HTTPS = 0;
	// const SMSC_CHARSET = "utf-8";
	// const SMSC_DEBUG = 0;
	// const SMSC_FROM = "info@tklient.ru";
	...
	public function send_sms($phones, $message, $translit = 0, $time = 0, $id = 0, $format = 0, $sender = "TKlient.ru", $query = "", $files = array())
	{
	...
	public function _smsc_read_url($url, $files)
	{
		$ret = "";
