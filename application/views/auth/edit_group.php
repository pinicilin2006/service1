          ...
          <div class="blog-post">
				...
				<legend><?php echo lang('edit_group_heading');?></legend>
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="text" name="group_name" value="<?=$group_name['value']?>" class="form-control" id="group_name" placeholder="Название группы">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="group_description" class="col-sm-4 control-label">Описание</label>
				    <div class="col-sm-8">
				      <input type="text" name="group_description" value="<?=$group_description['value']?>" class="form-control" id="group_description" placeholder="Описание">
				    </div>
				  </div>				  
				  <div class="form-group">
