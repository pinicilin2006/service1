...
<!-- 			<div class="blog-header">
			    <h1 class="blog-title"><a href="http://tklient.ru">TKlient.ru</a> - </h1>
			    ...
			    <script type="text/javascript">(function() {
					...
					<div class="pluso" data-background="#ebebeb" data-options="small,square,line,horizontal,counter,theme=06" data-services="vkontakte,odnoklassniki,facebook,twitter,google,moimir,email,print"></div>    
			</div> -->
			<div class="blog-header">
					<div class="col-sm-4">
